...
export const KERALA_DESIGNS = {
  Engagement: [
    ...
    },
    {
      ...
      title: 'Lakeside Pavilion with Lotus Border',
      image: `${BASE}/Engagement/download (2).jpg`,
      overlays: [OVERLAY.WATER, OVERLAY.LOTUS_BLOOM, OVERLAY.PETALS_LOTUS, OVERLAY.BRASS_LAMPS],
      bg: '#0E4047',
      textColor: KERALA_COLORS.text,
      textBackdrop: 'rgba(5,40,45,0.50)',
      textPlacement: 'center',
      headline: 'A Promise by the Water',
      description: 'Brass lamps flicker, lotus petals drift, and the backwaters hold the moment still.',
    },
  ],
