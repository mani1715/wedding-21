...
const Mughal = (() => {
  ...
  return {
    ...
    events: {
      ...
      Haldi: [
        { id: 'mughal_haldi_1', title: 'Royal Haldi Swing', image: `${b}/Haldi/Haldi vibes Layout.jpg`,
          overlays: [O.SWING, O.PETALS_MARIGOLD, O.TURMERIC_STEAM, O.GOLD_DUST],
          ...onDarkText(t.accent), textPlacement: 'top',
          headline: 'A Royal Haldi', description: 'A jewelled swing, marigold petals and turmeric steam.' },
        ...
        { id: 'mughal_haldi_3', title: 'Grand Mughal Haldi', image: `${b}/Haldi/download.jpg`,
          overlays: [O.PETALS_MARIGOLD, O.MOROCCAN_LANTERN, O.GOLD_DUST],
          ...onDarkText(t.accent), textPlacement: 'bottom',
          headline: 'Mughal Haldi Day', description: 'Lanterns above, marigold cascading down.' },
      ],
      Mehandi: [
      ...
      Sangeeth: [
        { id: 'mughal_sangeeth_1', title: 'Sangeet at the Palace', image: `/designs/all/Mughal/Sangeeth/Editable Pink Mehndi Welcome Sign & Invitation _ 2 in 1 Sangeet Dholki Canva Template Bundle.jpg`,
          overlays: [O.MOROCCAN_LANTERN, O.CONFETTI_GOLD, O.FIREFLY, O.PETALS_BOUGAINVILLEA],
          ...onLightText(t.accent, '#5A1228'), textPlacement: 'top',
          headline: 'Palace Sangeet', description: 'Lanterns lit, confetti falling, family dancing.' },
