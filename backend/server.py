...
async def create_profile(
    ...
    profile = Profile(
        ...
        guest_rooms=profile_data.guest_rooms or [],
        pre_wedding_links=profile_data.pre_wedding_links or [],
        rsvp_settings=profile_data.rsvp_settings or RSVPSettings(),  # Phase 1C
        honeymoon_fund=profile_data.honeymoon_fund or HoneymoonFund(),  # Phase 1H
...
app.include_router(build_music_library_router())
...
app.include_router(music_library_router)
